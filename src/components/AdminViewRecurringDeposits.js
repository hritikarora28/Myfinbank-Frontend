...
const AdminViewRecurringDeposits = () => {
    ...
    useEffect(() => {
        const fetchRecurringDeposits = async () => {
            try {
                const response = await axios.get(`${API_URL}/api/transactions/all-recurring-deposits`, {
                    headers: {
    ...
    return (
        <Container className="mt-4">
            <h2>All User Recurring Deposits</h2>
...
export default AdminViewRecurringDeposits;
